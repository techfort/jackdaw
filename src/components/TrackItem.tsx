        ...
        >
          <div className="absolute top-4 left-2 flex flex-col gap-2 bg-[var(--color-bg-surface)] border border-[var(--color-playhead)] p-3 rounded-lg shadow-2xl z-50 w-64 animate-in fade-in zoom-in duration-200 pointer-events-auto">
            ...
            <textarea 
              ...
              className="bg-[var(--color-bg-deep)] border border-[var(--color-border-inner)] rounded p-2 text-xs text-white focus:outline-none focus:border-[var(--color-accent)] resize-none h-20"
            />
            <div className="flex justify-between items-center">
              <span className="text-[9px] text-[var(--color-text-muted)]">Press Enter to save • Esc to cancel</span>
              <button 
